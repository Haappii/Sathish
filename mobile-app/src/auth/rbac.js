...
export const mobileMenuCatalog = [
  ...
  },
  {
    ...
    icon: "📊",
    route: "Dashboard",
    // Web's /dashboard has no dedicated permission module — open to any
    // authenticated user, same as here (no perm = canAccess allows it).
    fallbackRoles: ALL_ROLES,
  },
  {
    key: "analytics",
  ...
  },
  {
    ...
    icon: "🍳",
    route: "Recipes",
    perm: { module: "items", action: "write" },
    fallbackRoles: new Set(["admin", "manager"]),
    hotelOnly: true,
  },
  {
  ...
  // ── Setup / Admin ───────────────────────────────────────────────────
  {
    ...
    icon: "🗂️",
    route: "Categories",
    perm: { module: "categories", action: "write" },
    fallbackRoles: new Set(["admin", "manager"]),
  },
  {
    key: "setup_items",
  ...
  },
  {
    ...
    icon: "🚚",
    route: "Suppliers",
    perm: { module: "suppliers", action: "write" },
    fallbackRoles: new Set(["admin", "manager"]),
  },
  {
    key: "purchase_orders",
    ...
    perm: { module: "purchase_orders", action: "write" },
    fallbackRoles: new Set(["admin", "manager"]),
  },
  {
    key: "setup_users",
    ...
    icon: "👤",
    route: "Users",
    perm: { module: "users", action: "write" },
    fallbackRoles: new Set(["admin"]),
  },
  {
    key: "setup_permissions",
    title: "Permissions",
    icon: "🔐",
    route: "Permissions",
    perm: { module: "roles", action: "write" },
    fallbackRoles: new Set(["admin"]),
  },
  {
    key: "branches",
    ...
    icon: "🏬",
    route: "Branches",
    perm: { module: "setup", action: "write" },
    fallbackRoles: new Set(["admin"]),
  },
  {
    key: "shop_settings",
  ...
  },
  {
    ...
    icon: "💵",
    route: "CashDenominations",
    perm: { module: "cash_drawer", action: "write" },
    fallbackRoles: new Set(["admin", "manager"]),
  },
  {
