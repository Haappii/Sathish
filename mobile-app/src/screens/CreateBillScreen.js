...
export default function CreateBillScreen({ route }) {
  ...
  const discountValue = useMemo(
    () => Math.round(Math.min(grossTotal, Math.max(0, manualDiscountValue + Number(couponDiscount || 0)))),
  ...
  const saveInvoice = async (action = BILL_ACTIONS.PRINT_BOTH, utrCode = null) => {
    ...
    const normalizedDiscount = discountValue;
    const splitPayload = {
                ...
                <Pressable style={[styles.itemCard, inCart && styles.itemCardActive]} onPress={() => addToCart(item)}>
                  {resolveItemImageUrl(item) ? (
                    ...
                    <View style={[styles.itemThumb, styles.itemThumbFallback]}>
                      <Text style={styles.itemThumbPlaceholderIcon}>🛍️</Text>
                    </View>
                  )}
                ...
                <View style={styles.qtyWrap}>
                  {isWeightItem(x) ? (
                    ...
                    <>
                      ...
                      <Pressable style={[styles.qtyBtn, { backgroundColor: theme.accent }]} onPress={() => changeQty(x.item_id, 1)}>
...
const styles = StyleSheet.create({
  ...
  offlineBanner: { backgroundColor: "#7c2d12", paddingVertical: 11, paddingHorizontal: 16, alignItems: "center" },
  offlineBannerText: { color: "#fed7aa", fontWeight: "700", fontSize: 13 },
  syncBanner: { backgroundColor: "#6366f1", paddingVertical: 11, paddingHorizontal: 16, alignItems: "center" },
  ...
  sectionTitle: { fontSize: 12, fontWeight: "900", color: "#4b5563", letterSpacing: 1, textTransform: "uppercase", borderLeftWidth: 3, borderLeftColor: "#2563eb", paddingLeft: 9 },
  input: {
    borderWidth: 1.5,
    borderColor: "#e4e9f2",
    borderRadius: 12,
  ...
  itemThumbPlaceholderIcon: { fontSize: 20, opacity: 0.45 },
  itemCardActive: { borderColor: "#2563eb", backgroundColor: "#eef2ff" },
  itemName:    { fontWeight: "800", color: "#0a0f1e", fontSize: 10, lineHeight: 13 },
  itemPrice:   { color: "#6366f1", fontWeight: "900", fontSize: 11 },
  inCartBadge: { marginTop: 2, color: "#10b981", fontSize: 11, fontWeight: "700" },
  cartRow: {
    flexDirection: "row",
    alignItems: "center",
    borderWidth: 1.5,
  ...
  cartName:   { fontWeight: "700", color: "#0a0f1e", fontSize: 14 },
  cartAmount: { marginTop: 2, color: "#4b5563", fontSize: 13 },
  cartMeta: { marginTop: 2, color: "#9ca3af", fontSize: 11 },
  ...
  qtyTxt:   { fontSize: 18, color: "#0a0f1e", fontWeight: "700" },
  qtyValue: { fontWeight: "800", color: "#0a0f1e", minWidth: 22, textAlign: "center", fontSize: 15 },
  weightInput: {
    minWidth: 56,
    borderWidth: 1.5,
    borderColor: "#e4e9f2",
  ...
  gramTxt: { color: "#9ca3af", fontWeight: "700", fontSize: 12 },
  removeTxt: { color: "#ef4444", fontSize: 17, fontWeight: "700", paddingHorizontal: 5 },
  total: { fontSize: 17, fontWeight: "800", color: "#10b981", textAlign: "right" },
  loyaltyPts: { fontSize: 12, fontWeight: "700", color: "#b87008", textAlign: "right", marginTop: 2 },
  customerDueText: { fontSize: 14, fontWeight: "700", color: "#ef4444", textAlign: "right", marginTop: 4 },
  collectTotal: { fontSize: 17, fontWeight: "800", color: "#ef4444", textAlign: "right", marginTop: 2, borderTopWidth: 1, borderTopColor: "#fca5a5", paddingTop: 6 },
  ...
  upiModalTitle: { fontSize: 18, fontWeight: "900", color: "#0a0f1e", textAlign: "center", marginBottom: 4 },
  upiQrWrap: {
    alignItems: "center",
    backgroundColor: "#f8f9fd",
    borderRadius: 16,
  ...
  upiIdLabel: { fontSize: 13, fontWeight: "700", color: "#4b5563", textAlign: "center" },
  upiAmtLabel: { fontSize: 16, fontWeight: "900", color: "#6366f1", textAlign: "center" },
  upiNoId: {
  ...
  upiTabActive: { backgroundColor: "#6366f1", borderColor: "#2563eb" },
  upiTabText: { fontSize: 12, fontWeight: "700", color: "#4b5563" },
  upiTabTextActive: { color: "#fff" },
  upiFieldLabel: { fontSize: 12, fontWeight: "700", color: "#4b5563" },
  ...
  upiCancelTxt: { color: "#4b5563", fontWeight: "700", fontSize: 14 },
  upiDoneBtn: {
    flex: 2,
  ...
  saveTxt: { color: "#fff", fontWeight: "900", fontSize: 16, letterSpacing: 0.2 },
  saveOnlyBtn: {
    marginTop: 4,
    borderRadius: 14,
  ...
  saveOnlyTxt: { color: "#fff", fontWeight: "800", fontSize: 15 },
  holdBtn: {
    marginTop: 4,
    borderRadius: 14,
  ...
  holdTxt: { color: "#fff", fontWeight: "800", fontSize: 15 },
  modalBackdrop: {
    flex: 1,
  ...
  weightModalTitle: { fontSize: 17, fontWeight: "800", color: "#0a0f1e" },
  weightModalItem: { color: "#4b5563", fontWeight: "600", fontSize: 14 },
  weightModalInput: {
    borderWidth: 1.5,
    borderColor: "#e4e9f2",
    borderRadius: 12,
  ...
  weightModalCancel: { backgroundColor: "#eef2ff", borderWidth: 1.5, borderColor: "#e4e9f2" },
  weightModalConfirm: { backgroundColor: "#6366f1" },
  weightModalCancelText: { color: "#4b5563", fontWeight: "700" },
  weightModalConfirmText: { color: "#fff", fontWeight: "700" },
  // ── Stock badge ────────────────────────────────────────────────────────────
  stockBadge: { marginTop: 3, fontSize: 10, fontWeight: "700", color: "#10b981" },
  stockBadgeOut: { color: "#ef4444" },
  // ── Held drafts banner ─────────────────────────────────────────────────────
  heldBanner: { backgroundColor: "#92400e", paddingVertical: 11, paddingHorizontal: 16, alignItems: "center" },
  ...
  heldModalTitle: { fontSize: 16, fontWeight: "900", color: "#92400e" },
  heldModalClose: { fontSize: 18, fontWeight: "700", color: "#92400e", paddingHorizontal: 6 },
  heldEmptyText: { textAlign: "center", color: "#9ca3af", fontSize: 13, padding: 24 },
  heldDraftCard: {
    padding: 14,
    borderBottomWidth: 1,
  ...
  heldDraftRow: { flexDirection: "row", justifyContent: "space-between", marginBottom: 3 },
  heldDraftNumber: { fontSize: 12, fontWeight: "800", color: "#92400e" },
  heldDraftCount: { fontSize: 11, color: "#9ca3af", fontWeight: "600" },
  heldDraftName: { fontSize: 14, fontWeight: "700", color: "#0a0f1e" },
  heldDraftMobile: { fontSize: 11, color: "#4b5563", marginTop: 2 },
  heldDraftAmount: { fontSize: 14, fontWeight: "800", color: "#6366f1", marginTop: 5 },
  // ── Price level ────────────────────────────────────────────────────────────
  priceLevelRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  priceLevelLabel: { fontSize: 12, fontWeight: "700", color: "#4b5563", flexShrink: 0 },
  priceLevelBtn: {
    borderWidth: 1.5,
    borderColor: "#e4e9f2",
    borderRadius: 9,
  ...
  priceLevelBtnActive: { backgroundColor: "#6366f1", borderColor: "#2563eb" },
  priceLevelTxt: { fontSize: 11, fontWeight: "700", color: "#4b5563" },
  ...
  couponClearTxt: { color: "#4b5563", fontWeight: "700", fontSize: 12 },
  couponMsg: { fontSize: 11, fontWeight: "600", color: "#ef4444", marginTop: 2 },
  couponMsgSuccess: { color: "#10b981" },
  couponDiscountLine: { fontSize: 14, fontWeight: "700", color: "#10b981", textAlign: "right" },
  ...
  discTypeBtnActive: { backgroundColor: "#6366f1", borderColor: "#2563eb" },
  discTypeTxt: { fontSize: 11, fontWeight: "700", color: "#4b5563" },
