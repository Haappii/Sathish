                ...
                <View style={styles.qtyWrap}>
                  {isWeightItem(x) ? (
                    ...
                    <>
                      ...
                      <Pressable style={[styles.qtyBtn, { backgroundColor: "#2563eb" }]} onPress={() => changeQty(x.item_id, 1)}>
...
const styles = StyleSheet.create({
  ...
  syncBanner: { backgroundColor: "#1d4ed8", paddingVertical: 11, paddingHorizontal: 16, alignItems: "center" },
  ...
  sectionTitle: { fontSize: 12, fontWeight: "900", color: "#4a5a78", letterSpacing: 1, textTransform: "uppercase", borderLeftWidth: 3, borderLeftColor: "#2563eb", paddingLeft: 9 },
  input: {
    borderWidth: 1.5,
    borderColor: "#d0dcf0",
    borderRadius: 12,
  ...
  itemCardActive: { borderColor: "#2563eb", backgroundColor: "#eff4ff" },
  itemName:    { fontWeight: "800", color: "#0c1228", fontSize: 10, lineHeight: 13 },
  itemPrice:   { color: "#2563eb", fontWeight: "900", fontSize: 11 },
  inCartBadge: { marginTop: 2, color: "#059669", fontSize: 11, fontWeight: "700" },
  cartRow: {
    flexDirection: "row",
    alignItems: "center",
    borderWidth: 1.5,
  ...
  cartName:   { fontWeight: "700", color: "#0c1228", fontSize: 14 },
  cartAmount: { marginTop: 2, color: "#4a5a78", fontSize: 13 },
  cartMeta: { marginTop: 2, color: "#8896ae", fontSize: 11 },
  ...
  qtyTxt:   { fontSize: 18, color: "#0c1228", fontWeight: "700" },
  qtyValue: { fontWeight: "800", color: "#0c1228", minWidth: 22, textAlign: "center", fontSize: 15 },
  weightInput: {
    minWidth: 56,
    borderWidth: 1.5,
    borderColor: "#d0dcf0",
  ...
  gramTxt: { color: "#8896ae", fontWeight: "700", fontSize: 12 },
  removeTxt: { color: "#dc2626", fontSize: 17, fontWeight: "700", paddingHorizontal: 5 },
  total: { fontSize: 17, fontWeight: "800", color: "#059669", textAlign: "right" },
  ...
  collectTotal: { fontSize: 17, fontWeight: "800", color: "#dc2626", textAlign: "right", marginTop: 2, borderTopWidth: 1, borderTopColor: "#fca5a5", paddingTop: 6 },
  ...
  upiModalTitle: { fontSize: 18, fontWeight: "900", color: "#0c1228", textAlign: "center", marginBottom: 4 },
  upiQrWrap: {
    alignItems: "center",
    backgroundColor: "#f6f8fe",
    borderRadius: 16,
  ...
  upiIdLabel: { fontSize: 13, fontWeight: "700", color: "#4a5a78", textAlign: "center" },
  upiAmtLabel: { fontSize: 16, fontWeight: "900", color: "#2563eb", textAlign: "center" },
  upiNoId: {
  ...
  upiFieldLabel: { fontSize: 12, fontWeight: "700", color: "#4a5a78" },
  ...
  upiCancelTxt: { color: "#4a5a78", fontWeight: "700", fontSize: 14 },
  upiDoneBtn: {
    flex: 2,
  ...
  weightModalTitle: { fontSize: 17, fontWeight: "800", color: "#0c1228" },
  weightModalItem: { color: "#4a5a78", fontWeight: "600", fontSize: 14 },
  weightModalInput: {
    borderWidth: 1.5,
    borderColor: "#d0dcf0",
    borderRadius: 12,
  ...
  weightModalCancel: { backgroundColor: "#eef2ff", borderWidth: 1.5, borderColor: "#dde6f7" },
  weightModalConfirm: { backgroundColor: "#2563eb" },
  weightModalCancelText: { color: "#4a5a78", fontWeight: "700" },
  weightModalConfirmText: { color: "#fff", fontWeight: "700" },
  // ── Stock badge ────────────────────────────────────────────────────────────
  stockBadge: { marginTop: 3, fontSize: 10, fontWeight: "700", color: "#059669" },
  ...
  heldEmptyText: { textAlign: "center", color: "#8896ae", fontSize: 13, padding: 24 },
  heldDraftCard: {
    padding: 14,
    borderBottomWidth: 1,
  ...
  heldDraftCount: { fontSize: 11, color: "#8896ae", fontWeight: "600" },
  heldDraftName: { fontSize: 14, fontWeight: "700", color: "#0c1228" },
  heldDraftMobile: { fontSize: 11, color: "#4a5a78", marginTop: 2 },
  heldDraftAmount: { fontSize: 14, fontWeight: "800", color: "#2563eb", marginTop: 5 },
  // ── Price level ────────────────────────────────────────────────────────────
  priceLevelRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  priceLevelLabel: { fontSize: 12, fontWeight: "700", color: "#4a5a78", flexShrink: 0 },
  priceLevelBtn: {
    borderWidth: 1.5,
    borderColor: "#d0dcf0",
    borderRadius: 9,
  ...
  priceLevelBtnActive: { backgroundColor: "#2563eb", borderColor: "#2563eb" },
  priceLevelTxt: { fontSize: 11, fontWeight: "700", color: "#4a5a78" },
  ...
  couponClearTxt: { color: "#4a5a78", fontWeight: "700", fontSize: 12 },
  couponMsg: { fontSize: 11, fontWeight: "600", color: "#dc2626", marginTop: 2 },
  couponMsgSuccess: { color: "#059669" },
  couponDiscountLine: { fontSize: 14, fontWeight: "700", color: "#059669", textAlign: "right" },
  ...
  discTypeBtnActive: { backgroundColor: "#2563eb", borderColor: "#2563eb" },
  discTypeTxt: { fontSize: 11, fontWeight: "700", color: "#4a5a78" },
