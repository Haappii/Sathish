          ...
          return (
            <View key={item.item_id} style={styles.itemCard}>
              ...
              <View style={styles.qtyRow}>
                ...
                <Pressable style={[styles.qtyBtn, { backgroundColor: theme.accent }]} onPress={() => adjust(item.item_id, 1)}>
...
const styles = StyleSheet.create({
  ...
  billBtn:     { backgroundColor: "#ffffff", borderRadius: 8, paddingHorizontal: 14, paddingVertical: 6 },
  billBtnText: { color: "#6366f1", fontWeight: "800" },
  ...
  catChipActive: { backgroundColor: "#6366f1", borderColor: "#2563eb" },
  ...
  qtyBtn:    { width: 32, height: 32, borderRadius: 8, backgroundColor: "#f4f6fb", alignItems: "center", justifyContent: "center", borderWidth: 1.5, borderColor: "#e4e9f2" },
  ...
  kotBtn:    { backgroundColor: "#ffffff", borderRadius: 10, paddingHorizontal: 20, paddingVertical: 10 },
  kotBtnText: { color: "#6366f1", fontWeight: "800" },
  modalBackdrop: {
    flex: 1,
  ...
  modalTotal: { textAlign: "right", fontWeight: "800", fontSize: 16, color: "#10b981" },
  modalBreakdown: { textAlign: "right", color: "#334155", fontWeight: "600" },
  modalGrandTotal: { textAlign: "right", fontWeight: "900", fontSize: 18, color: "#10b981" },
  lookupHint: { color: "#6366f1", fontSize: 12, fontWeight: "600" },
  transferRow: {
    borderWidth: 1,
    borderColor: "#e4e9f2",
    borderRadius: 10,
  ...
  transferRowCategory: { fontWeight: "400", color: "#9ca3af", opacity: 0.85 },
  emptyTransferText: { color: "#9ca3af", paddingVertical: 6 },
  ...
  paymentBtnActive: { backgroundColor: "#6366f1", borderColor: "#2563eb" },
  ...
  upiQrAmt: { fontSize: 14, fontWeight: "800", color: "#6366f1", textAlign: "center" },
  upiNoIdBox: {
