...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 13, fontWeight: "800", color: "#0a0f1e", letterSpacing: 0.6, textTransform: "uppercase" },
  businessDate: { color: "#6366f1", fontWeight: "800", fontSize: 12 },
  input: {
    borderWidth: 1.5,
    borderColor: "#e4e9f2",
    borderRadius: 12,
  ...
  refreshTxt: { fontWeight: "700", color: "#6366f1", fontSize: 13 },
  ...
  sub: { marginTop: 3, color: "#4b5563", fontSize: 12 },
  amount: { marginLeft: 8, fontWeight: "800", color: "#10b981", fontSize: 15 },
  ...
  modalTitle: { fontSize: 17, fontWeight: "900", color: "#0a0f1e" },
  ...
  close: { color: "#6366f1", fontWeight: "800", fontSize: 14 },
  modalBody: { padding: 16, gap: 10 },
  detailLine: { color: "#4b5563", fontSize: 14 },
  itemsBox: {
    marginTop: 8,
    borderWidth: 1.5,
    borderColor: "#e4e9f2",
  ...
  itemsTitle: { fontWeight: "800", color: "#0a0f1e", fontSize: 14 },
  ...
  qtyLabel: { fontSize: 11, color: "#9ca3af", fontWeight: "600" },
  qtyStatic: { fontSize: 13, color: "#4b5563", fontWeight: "700" },
  totalLine: { marginTop: 3, color: "#4b5563", fontSize: 14 },
  totalBig: { marginTop: 10, fontSize: 20, fontWeight: "900", color: "#10b981", letterSpacing: -0.3 },
  editSection: {
    marginTop: 14,
    borderWidth: 1.5,
    borderColor: "#e4e9f2",
  ...
  modeText: { color: "#4b5563", fontWeight: "700", fontSize: 11 },
